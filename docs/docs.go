                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.CreateAccountInput"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.UpdateAccountInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/transactions/{id}": {
            "delete": {
                ...
                "responses": {
                    ...
                    "422": {
                        "description": "Deletion would make account balance negative",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
